<script>
  ...
  //  onMount(()=>{
  //   var allFolders = document.querySelector(".directory-list li > ul");
  //   // console.log(allFolders)
  //   allFolders.each(function() {

  //     // add the folder class to the parent <li>
  //     var folderAndName = document.querySelector(this).parent();
  //     console.log(folderAndName)
  //     folderAndName.classList.add("folder");

  //     // backup this inner <ul>
  //     var backupOfThisFolder = document.querySelector(this);
  //     // then delete it
  //     document.querySelector(this).remove();
  //     // add an <a> tag to whats left ie. the folder name
  //     folderAndName.wrapInner("<a href='#' />");
  //     // then put the inner <ul> back
  //     folderAndName.insertAdjacentHTML("beforeend",backupOfThisFolder);

  //     // now add a slideToggle to the <a> we just added
  //     folderAndName.querySelector("a").click(function(e) {
  //       document.querySelector(this).siblings("ul").slideToggle("slow");
  //       e.preventDefault();
  //     });
